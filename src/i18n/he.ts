...
const he = {
  ...
  settings: {
    ...
    kidEmoji: "אימוג׳י",
    kidColor: "צבע",
    invite: "הזמנת בן/בת זוג",
    inviteSubtitle: "שתפו את הקוד כדי שבן/בת הזוג יוכלו להירשם ולנהל את המשפחה ביחד",
    generateInvite: "צור קוד הזמנה",
    inviteCode: "קוד ההזמנה",
    copyCode: "העתק קוד",
    codeCopied: "הקוד הועתק!",
    inviteExpires: "תוקף: {{days}} ימים",
  ...
  customization: {
    ...
    addSubcategoryTitle: "תת-קטגוריה חדשה",
    editSubcategory: "עריכת תת-קטגוריה",
    subcategoryName: "שם",
    subcategoryPlaceholder: "שם תת-קטגוריה",
    subcategoryIcon: "אייקון",
    subcategoryColor: "צבע",
  ...
  onboarding: {
    ...
    step4Title: "הזמינו את בן/בת הזוג",
    step4Subtitle:
      "שתפו את הקוד כדי שבן/בת הזוג יוכלו להירשם ולנהל את המשפחה ביחד.\nאפשר גם מאוחר יותר מההגדרות.",
    step4Skip: "אעשה את זה אחר כך",
    step5Title: "עוזר משפחתי בטלגרם",
    step5Subtitle:
  ...
  budget: {
    ...
    recurringNudge: "{{count}} הוצאות קבועות ממתינות לרישום",
    recurringNudgeOne: "הוצאה קבועה אחת ממתינה לרישום",
    logThisMonth: "רשום לחודש זה",
    logThisWeek: "רשום לשבוע זה",
