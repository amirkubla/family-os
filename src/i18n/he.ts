...
const he = {
  ...
  voice: {
    ...
    reviewTitlePayment: "תשלום מההקלטה",
    addPayment: "הוסף תשלום",
    missingDetails: "חסרים פרטים",
    missingAmount: "סכום",
    missingRecurrence: "יום קבוע (בשבוע או בחודש)",
    paymentOneTime: "חד פעמי",
    paymentEveryWeek: "כל שבוע, ביום {{day}}",
    paymentEveryMonth: "כל חודש, ביום {{day}}",
    reviewTitleEvent: "אירוע מההקלטה",
    missingTitle: "כותרת",
    missingDate: "תאריך",
    missingTime: "שעה",
    missingDays: "ימים",
    eventAllDay: "כל היום",
    eventEveryWeek: "כל שבוע",
  ...
  eventModal: {
    ...
    day: "יום",
    date: "תאריך",
    endDate: "עד תאריך (אופציונלי)",
    endDateBeforeStart: "תאריך הסיום לפני תאריך ההתחלה",
    dateRequired: "תאריך הוא שדה חובה",
    invalidDate: "תאריך לא תקין (YYYY-MM-DD)",
    time: "שעה",
    timed: "עם שעה",
  ...
  auth: {
    ...
    continue: "המשך",
    back: "חזרה",
    useSocialLogin: "חשבון זה מחובר עם Google — התחברו עם Google",
    // ── Family step (second page of registration) ──
    chooseFamilyTitle: "בחרו משפחה",
    chooseFamilySubtitle: "צרו משפחה חדשה או הצטרפו עם קוד הזמנה",
    // ── Google sign-in ──
    or: "או",
    orWithPassword: "או עם שם משתמש וסיסמה",
    ...
    appleFailed: "ההתחברות עם Apple נכשלה — נסו שנית",
    googleWelcomeTitle: "ברוך הבא! 👋",
    googleWelcomeSubtitle: "עוד צעד אחד — בחרו משפחה כדי להמשיך",
    loading: "טוען…",
    logout: "התנתק",
    account: "חשבון",
